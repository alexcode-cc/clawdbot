...
- [05 - Agent 系統](./05-Agent系統.md) - AI Agent、30+ 提供者、工具策略、Context Engine、Compaction、Fast Mode、Plugin Capability、TaskFlow 背景任務、MCP 遠端支援、Dreaming 記憶系統、Prompt Cache 穩定性、影片/音樂生成
- [06 - 通訊頻道](./06-通訊頻道.md) - 8 內建 + 35+ 擴充頻道（含 QQ Bot、QA Lab）、Web Search 插件、Outbound 插件化、Matrix Draft Streaming + 原生 Exec Approvals

### 擴充與應用
- [07 - 擴充套件開發](./07-擴充套件開發.md) - 插件架構、Plugin Capability（Web Search/Image Gen/TTS/Media）、ClawHub 市場、Provider 懶加載、Channel 懶加載、Plugin Config TUI
...
- [13 - 大模型設定與驗證詳解](./13-大模型設定與驗證詳解.md) - 30+ 提供者設定、認證流程、模型切換、驗證方法
...
- [2026-04-05 提交分析](./commit-analyze-20260405.md) - 3,098 個提交分析（2026.3.31 → 2026.4.5）
- [2026-04-08 提交分析](./commit-analyze-20260408.md) - 1,705 個提交分析（2026.4.5 → 2026.4.8）
- [2026-04-12 提交分析](./commit-analyze-20260412.md) - 1,928 個提交分析（2026.4.8 → 2026.4.12）
- [2026-04-14 提交分析](./commit-analyze-20260414.md) - 267 個提交分析（2026.4.12 → 2026.4.14）
- [2026-04-15 提交分析](./commit-analyze-20260415.md) - 417 個提交分析（2026.4.14 → 2026.4.15）
- [2026-04-20 提交分析](./commit-analyze-20260420.md) - 1,503 個提交分析（2026.4.15 → 2026.4.20）
- [2026-04-21 提交分析](./commit-analyze-20260421.md) - 11 個提交分析（2026.4.20 → 2026.4.21）
- [2026-04-23 提交分析](./commit-analyze-20260423.md) - 1,277 個提交分析（2026.4.21 → 2026.4.23，含 2026.4.22 / 2026.4.23 變更彙整）
- [2026-04-24 提交分析](./commit-analyze-20260424.md) - 899 個提交分析（2026.4.23 → 2026.4.24）
- [2026-04-25 提交分析](./commit-analyze-20260425.md) - 1,049 個提交分析（2026.4.24 → 2026.4.25）
- [2026-04-26 提交分析](./commit-analyze-20260426.md) - 829 個提交分析（2026.4.25 → 2026.4.26）
- [2026-04-27 提交分析](./commit-analyze-20260427.md) - 主線約 **4000** 個非合併提交（`112b58dc76` ↔ `origin/main` 分叉後增量；CHANGELOG **Unreleased**）
- [2026-04-29 提交分析](./commit-analyze-20260429.md) - **`aa339fbb79` 後無本機增量**、`origin/main` 仍 **`da1e1435ad`** 之對齊說明（完整 Unreleased 見 **60427**）
- [2026-05-02 提交分析](./commit-analyze-20260502.md) - **`CHANGELOG` → ## 2026.5.2** 主題摘要（對齊 **`v2026.5.2`**）
- [2026-05-03 提交分析](./commit-analyze-20260503.md) - **`CHANGELOG` → ## 2026.5.3** 主題摘要（對齊 **`v2026.5.3`**／套件 **`2026.5.3`**；Fixes 區含承載條目說明見該檔）
- [2026-05-04 提交分析](./commit-analyze-20260504.md) - **`CHANGELOG` → ## 2026.5.4** 主題摘要（對齊 **`v2026.5.4`**／套件 **`2026.5.4`**；自 **`v2026.5.3`** 起約 527 筆提交）
- [2026-05-05 提交分析](./commit-analyze-20260505.md) - **`CHANGELOG` → ## 2026.5.5** 修復摘要（對齊 **`v2026.5.5`**／套件 **`2026.5.5`**；自 **`v2026.5.4`** 起 54 筆提交）
